...
@Component({
  selector: 'main-section-intro-menu',
  templateUrl: './section-intro-menu.component.html',
  styleUrls: ['./section-intro-menu.component.scss'],
})
export class SectionIntroMenuComponent implements OnInit {
